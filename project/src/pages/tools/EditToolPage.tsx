...
export const EditToolPage: React.FC = () => {
  ...
  const { currentTool, updateTool, loadToolWithJobs, isLoading } = useToolsStore();
  ...
  useEffect(() => {
    if (currentTool) {
      setFormData({
        ...
        isRobust: currentTool.isRobust,
        complexDescription: currentTool.complexDescription || '',
        variations: currentTool.variations || [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: 'Error al actualizar la herramienta' });
    }
  };
        ...
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Modificar la información de la herramienta
            </p>
          </div>
        </div>
